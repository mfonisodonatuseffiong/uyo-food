        ...
        <div className="row justify-content-center g-0">
          <div className="col-xl-9">
            ...
            <div className="col-lg-6 text-center mx-auto mb-3 mb-md-5 mt-4">
              <motion.h2
                className="fw-bold text-dark fs-3 fs-lg-5 lh-sm my-4"
            ...
            <div className="row">
              {steps.map((step, index) => (
                <motion.div
                  ...
                  viewport={{ once: true }}
                >
                  <div className="glass-card text-center p-3 rounded shadow-sm h-100">
                    <img
            ...
            <div className="text-center mt-4">
              <button
                className="glass-btn btn btn-danger rounded-pill fw-bold px-4 me-3"
                onClick={() => navigate("/restaurants?type=delivery")}
              >
                <i className="fas fa-utensils me-2"></i> Start Ordering
              </button>
              <button
                className="glass-btn btn btn-dark rounded-pill fw-bold px-4"
