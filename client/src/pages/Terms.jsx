...
export default function Terms() {
  ...
  return (
    <section className="py-5 bg-warning" id="terms">   {/* ✅ Warning background */}
      <div className="container">
        <motion.h1
          className="fw-bold text-dark mb-4 text-center"
          {...fadeUp(0)}
        >
          <i className="fas fa-file-contract me-2 text-danger"></i> Terms & Conditions
        </motion.h1>
        <motion.p
        ...
        <div className="row">
          <motion.div className="col-md-12 mb-4" {...fadeUp(0.3)}>
            <h5 className="fw-bold text-danger">
              <i className="fas fa-concierge-bell me-2"></i> 1. Use of Service
            </h5>
          ...
          <motion.div className="col-md-12 mb-4" {...fadeUp(0.4)}>
            <h5 className="fw-bold text-danger">
              <i className="fas fa-credit-card me-2"></i> 2. Orders & Payments
            </h5>
            <p className="text-secondary">
          ...
          <motion.div className="col-md-12 mb-4" {...fadeUp(0.5)}>
            <h5 className="fw-bold text-danger">
              <i className="fas fa-truck me-2"></i> 3. Delivery
            </h5>
            <p className="text-secondary">
          ...
          <motion.div className="col-md-12 mb-4" {...fadeUp(0.6)}>
            <h5 className="fw-bold text-danger">
              <i className="fas fa-undo-alt me-2"></i> 4. Refunds & Cancellations
            </h5>
            <p className="text-secondary">
          ...
          <motion.div className="col-md-12 mb-4" {...fadeUp(0.7)}>
            <h5 className="fw-bold text-danger">
              <i className="fas fa-user-shield me-2"></i> 5. Privacy
            </h5>
            <p className="text-secondary">
          ...
          <motion.div className="col-md-12 mb-4" {...fadeUp(0.8)}>
            <h5 className="fw-bold text-danger">
              <i className="fas fa-sync-alt me-2"></i> 6. Changes to Terms
            </h5>
            <p className="text-secondary">
