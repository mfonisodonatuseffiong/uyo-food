...
export default function DealsPage() {
  return (
    <section className="pb-5 pt-8 bg-light" id="deals-page">
      <div className="container">
        <motion.h2
          ...
          viewport={{ once: true }}
        >
          <i className="fas fa-tags text-warning me-2"></i> Best Deals of the Week
        </motion.h2>

        <div className="row">
          <div className="col-12">
            <motion.div
              className="card card-span mb-3 shadow-lg border-0 rounded-4 overflow-hidden"
              ...
              <div className="row g-0 align-items-center">
                ...
                <div className="col-md-6 p-4 p-lg-5 text-center text-md-start">
                  <h2 className="fw-bold text-danger mb-3">
                    Best Deals on <span className="text-warning">Jollof Rice</span>
                  </h2>
                  ...
                  <div className="d-flex flex-wrap gap-3 justify-content-center justify-content-md-start">
                    <a
                      className="btn btn-lg btn-danger fw-bold rounded-pill shadow-sm"
                      href="/restaurants?dish=Jollof%20Rice&type=delivery"
                    >
                      <i className="fas fa-shopping-cart me-2"></i> Order Now
                    </a>
                    <a
                      className="btn btn-lg btn-outline-danger fw-bold rounded-pill shadow-sm"
