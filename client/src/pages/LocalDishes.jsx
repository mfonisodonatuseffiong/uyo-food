  ...
  return (
    <section className="py-5 bg-warning" id="local-dishes">
      <div className="container">
        <motion.h2
          className="fw-bold text-dark mb-5 text-center"
          {...fadeUp(0)}
        >
        ...
        <div className="row">
          {dishes.map((dish, idx) => (
            <motion.div
              ...
              {...fadeUp(0.2 + idx * 0.2)}
            >
              <div className="card shadow h-100 rounded-4 overflow-hidden glass-card">
                <div
                ...
                <div className="card-body text-center">
                  ...
                  <a
                    href={dish.link}
                    className="glass-btn btn btn-danger fw-bold rounded-pill mt-3"
                  >
